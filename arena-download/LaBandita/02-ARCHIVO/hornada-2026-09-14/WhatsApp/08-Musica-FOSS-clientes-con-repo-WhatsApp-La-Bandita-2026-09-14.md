...
Guía de clientes de música de código abierto, con el pulso de cada proyecto medido HOY, 14 de septiembre. La semana trajo movimiento de verdad en esta familia: OuterTune estrenó versión este mes, Metrolist sigue en racha de lanzamientos, y el linaje completo quedó documentado.

```
STREAMING (YouTube Music como fondo)
SimpMusic      ★11.217   2.1.0 (7-sep)     push 11-sep   vivo
OuterTune      ★5.391    v0.11.1 (6-sep)   push 6-sep    vivo
Metrolist      ★12.753   13.7.0 (7-sep)    vivo          ← la más activa
InnerTune      ★6.086    push nov-2025                   dormido
...
https://github.com/N-Zik-Group/N-Zik · v7.5.1-f (1 de septiembre) · tienda: https://appteka.store/app/4abr315772
...
Archivada en julio de 2025. El hilo de 340 mil caracteres de abril la trataba como viva: inflar no verifica. Su ficha de hoy dice: historia.
