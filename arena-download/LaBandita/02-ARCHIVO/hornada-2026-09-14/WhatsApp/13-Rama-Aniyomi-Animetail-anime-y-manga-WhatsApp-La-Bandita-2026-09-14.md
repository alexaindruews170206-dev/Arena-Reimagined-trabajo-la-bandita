...
```
Aniyomi     ★7.679   v0.18.2.1 (HOY 14-sep) push HOY       la rama madre
Animetail   ★578     v0.20.4.0 (5-ago)      push 7-sep    fork respaldado
Tadami      ★258     v0.62 (12-sep)         push 13-sep   fork, el más joven
```

Las tres viven. Y la noticia del día la da la madre: Aniyomi publicó DOS versiones este mismo 14 de septiembre, después de once meses sin releases — el mismo día en que su descendiente Animiru hacía lo propio en su rama. La familia entera se movió hoy. El criterio para elegir entre ellas no cambia: el uso real y el repo vivo, como con todo el árbol.
...
Licencia:     Apache-2.0
Versiones:    0.18.2.1 y 0.18.2.0 — publicadas HOY
              (la anterior estable: 0.18.1.2, del 28-oct-2025)
Push:         HOY (14 de septiembre de 2026)
...
Esta rama no son solo tres fichas: la red de forks de las tres casas se revisó HOY, fork por fork, en la API de GitHub. El panorama, con la trastienda abierta:
...
**La expedición profunda (la red entera, 649 miembros, caminada HOY):** el bosque no termina en la primera página. La red completa de Aniyomi — que es la misma de Animiru, familia por API — se caminó miembro a miembro: 93 cargan nombre propio. En la capa profunda, las rarezas que valen mención: **kikuyomi**, un fork de Aniyomi para escuchar **audiolibros**; **jishoyomi**, para estudiar con el anime (herramientas de aprendizaje); **Anichibi**, el fork lúdico con versiones V2 y V3; y un árbol dentro del árbol: **Kuukiyomi**, proyecto personal con siete miembros de red propios. El resto de la capa profunda son copias con README de fábrica: fuera del mapa. Con esa vara, el mapa queda completo.
...
La pregunta quedó respondida hoy mismo: v0.18.2.0 y v0.18.2.1, publicadas el 14 de septiembre tras once meses sin releases — con el código empujándose durante el mes. La organización sigue activa. Cuando dudes de un proyecto, el reloj es su página de releases, abierta ese día.
...
Comparte abuelo, pero su rama tiene pieza propia (la siguiente): allí vive su ficha completa, con las dos versiones que publicó hoy mismo.
