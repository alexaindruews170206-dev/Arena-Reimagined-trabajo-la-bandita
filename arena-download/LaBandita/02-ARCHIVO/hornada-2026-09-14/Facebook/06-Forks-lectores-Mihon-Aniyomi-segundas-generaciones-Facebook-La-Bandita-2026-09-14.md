...
```
━━ El tronco manga ━━
Mihon              ★23.575   v0.20.4 (5-ago)    push HOY
TachiyomiSY        ★4.144    1.13.2 (13-jul)    push ayer    fork
TachiyomiSYPreview ★484      host de previews   push 25-ago
Komikku            ★4.715    v1.14.1 (17-jul)   push 11-sep  rehijo
Neko               ★2.791    lector MangaDex    push HOY     especialista

━━ La rama anime (manga + anime) ━━
Aniyomi            ★7.680    push 4-sep         rama madre
Anikku             ★1.025    v0.2.0 (11-sep)    anime, org Komikku
Aniyomi-preview    ★641      host de previews   push 19-ago
Animetail          ★579      v0.20.4.0 (5-ago)  push 7-sep   fork
Tadami             ★258      v0.62 (12-sep)     push ayer    fork
...
Esta guía nombra repos con URL, licencia, versión y último push — todos leídos hoy. «El mejor» no aparece: no existe en abstracto. Existe el que cubre lo que lees, con taller abierto.
...
★23.575 · versión 0.20.4 (5 de agosto) · push de HOY · Apache-2.0. Es el lector manga libre más grande del mapa, y el sucesor de hecho de Tachiyomi. Su comunidad de traducciones empuja código a diario; sus versiones salen cuando salen — la de agosto es la vigente, y el push de hoy no significa APK nuevo.
...
★4.144 · versión 1.13.2 (13 de julio) · push de AYER · Apache-2.0. El fork clásico — fuentes extra, ajustes de lectura — que sigue abierto. Y el aviso que vale su entrada: el SY vivo es este — el nombre no basta; el dueño sí.

Su proyecto madre mantiene además un host de builds de prueba: TachiyomiSYPreview (★484) — versiones experimentales para curiosos, no la vía del día a día.

### Komikku — el rehijo con taller propio

https://github.com/komikku-app/komikku

★4.715 · versión 1.14.1 (17 de julio) · push del 11-sep · Apache-2.0. La API de GitHub no lo declara fork (es un repo nuevo); su README cuenta el linaje. Son los «rehijos»: proyectos que heredan el código y nacen con su propia casa. Su organización también mantiene Anikku (abajo).

### Neko — el especialista

https://github.com/nekomangaorg/Neko

★2.791 · push de HOY · «Unofficial MangaDex Reader for Android 8+». Un lector entero dedicado a una sola fuente: MangaDex. Es del linaje de los forks de Tachiyomi, pero su propósito propio es clarísimo: hacer una cosa bien. Para quien vive en MangaDex, es ficha aparte; para el resto, es un martillo con forma de destornillador.

### Aniyomi y sus herederos

https://github.com/aniyomiorg/aniyomi

★7.680 · push del 4-sep · Apache-2.0. La rama madre del manga+anime. Casi un año sin versión nueva pero con código moviéndose este mes: rama madura, no cadáver. Su host de previews: aniyomiorg/aniyomi-preview (★641).

**Anikku** — https://github.com/komikku-app/anikku — ★1.025 · versión 0.2.0 publicada el 11 de septiembre · «anime watcher» de la organización Komikku. La más activa de la rama anime este mes.
...
**Tadami** — https://github.com/andarcanum/Tadami-Aniyomi-fork — ★258 · versión 0.62 (12 de septiembre) · push de AYER · Apache-2.0. El más joven de la rama: tres versiones en un mes (0.60 → 0.62), manga + anime + novelas ligeras (ranobe). De los forks declarados, el que más rápido evoluciona.

## 🈁 La capa de inmersión (guía propia en la pieza 17)

El mapa de hoy estrena territorio: dos proyectos vivos de la capa japonesa del ecosistema. **Chimahon** (★198, GPL-3.0, v2.4.1 del 11-sep) es un fork de Mihon para estudiar leyendo: diccionario nativo Yomitan, manga Mokuro, novelas EPUB y minado instantáneo a Anki. **Yomi Reader** (★10, Apache-2.0, v0.1.7 del 6-sep) es el triple joven — anime, manga y novela — compatible con extensiones Tadami/Aniyomi. Las fichas completas, con Hoshi Reader, Yomikai y el cliente Komga «Koharia», viven en la pieza 17.
...
**SyncYomi** — https://github.com/syncyomi/syncyomi — ★710, push de HOY. Sincronización de bibliotecas entre dispositivos y entre forks del linaje Tachiyomi: tu progreso te sigue si cambias de lector de la familia. Un servidor ligero y el cliente en el teléfono.
...
Lo que la página de cada repo declaró HOY:
...
Dos vivos con estilo distinto. Hoy Komikku tiene más estrellas (4.715 vs 4.144); SY empujó ayer y Komikku el 11. Ningún número elige por ti.
