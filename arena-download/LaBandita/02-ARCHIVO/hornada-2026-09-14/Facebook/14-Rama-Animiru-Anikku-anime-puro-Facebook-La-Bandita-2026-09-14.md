...
├── 🌲 La red de forks de los dos (revisada HOY)
...
Hay una rama del árbol anime que tomó la decisión contraria a la de Aniyomi: en vez de añadir manga al reproductor, le QUITARON el manga para quedarse solo con el anime. Esta guía abrió HOY, 14 de septiembre, las casas de esa rama:

```
Animiru   ★863    v0.20.0.1 (HOY, 14-sep)   fork anime-only de Aniyomi
...
Licencia:     Apache-2.0
Versiones:    0.20.0.1 y 0.20.0.0 — publicadas HOY
...
Lo vivo y con propuesta en las dos redes (revisado HOY, fork por fork):
...
```
salmanbappi/extensions-repo      ★40 · push HOY
