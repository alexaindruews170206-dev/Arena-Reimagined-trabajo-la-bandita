...
Lo visto hoy: el sitio mantiene su banner de campaña — «F-Droid is under threat» — en el marco del programa de verificación de desarrolladores de Google que esta misma guía cronometra más abajo. El instalador de la propia tienda se descarga directo de su sitio.
...
Estado hoy:  viva, con campaña activa «under threat»
...
Lo visto hoy: el sitio responde; su carga depende de JavaScript, así que el navegador lo monta a su ritmo. Nada alarmante: es el mismo sitio de siempre.
...
La más popular de su especie: le dices qué repositorios te importan y ella vigila sus lanzamientos, descargando e instalando las versiones nuevas apenas salen. Hoy suma cerca de 19.700 estrellas y commits de ayer — de los proyectos más vivos de todo este mapa.
...
Vivo hoy. Complemento de instalación del ecosistema Obtainium: el eslabón entre «detecté una versión nueva» y «queda instalada en el teléfono».
...
Vivo hoy, con su landing cargando: se presenta como «un cliente F-Droid sin desorden que instala aplicaciones desde cualquier parte». De las apuestas nuevas por hacer el consumo de catálogos libres más amable.
...
- **Espacio APK** — sitio vivo hoy, catálogo de «apps y juegos populares». Su producto real: mods con promesas premium.
- **HappyMod** — respondió hoy sin título legible (escudo anti-bot). Su modelo de negocio: subir mods subidos por cualquiera, sin cadena de custodia seria.
- **Liteapks** — vivo hoy, se anuncia como «#1 en MOD APK». El número uno en mods es, por definición, el número uno en archivos sin revisión.
...
Contador de la campaña hoy: 110 días
```
