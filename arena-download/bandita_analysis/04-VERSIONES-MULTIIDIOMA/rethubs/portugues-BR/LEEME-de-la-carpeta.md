# Carpeta rethubs/portugues-BR — Foro Rethubs (reservada) · Portugués (Brasil)

Versión de plataforma **Foro Rethubs (reservada)** adaptada a **Portugués (Brasil)** — no traducción literal: adaptación de contexto (cultura, formato y tono de la plataforma, norma del idioma).
