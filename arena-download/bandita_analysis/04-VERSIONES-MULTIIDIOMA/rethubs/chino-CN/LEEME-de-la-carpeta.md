# Carpeta rethubs/chino-CN — Foro Rethubs (reservada) · Chino mandarín (simplificado)

Versión de plataforma **Foro Rethubs (reservada)** adaptada a **Chino mandarín (simplificado)** — no traducción literal: adaptación de contexto (cultura, formato y tono de la plataforma, norma del idioma).
