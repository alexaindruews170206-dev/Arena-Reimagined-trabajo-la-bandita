# Carpeta xda/portugues-BR — XDA Developers · Portugués (Brasil)

Versión de plataforma **XDA Developers** adaptada a **Portugués (Brasil)** — no traducción literal: adaptación de contexto (cultura, formato y tono de la plataforma, norma del idioma).
