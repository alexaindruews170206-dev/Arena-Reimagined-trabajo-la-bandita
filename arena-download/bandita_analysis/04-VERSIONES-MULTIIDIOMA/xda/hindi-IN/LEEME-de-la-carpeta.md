# Carpeta xda/hindi-IN — XDA Developers · Hindi

Versión de plataforma **XDA Developers** adaptada a **Hindi** — no traducción literal: adaptación de contexto (cultura, formato y tono de la plataforma, norma del idioma).
