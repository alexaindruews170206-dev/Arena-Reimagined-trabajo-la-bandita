# Carpeta telegram/hindi-IN — Telegram (reservada) · Hindi

Versión de plataforma **Telegram (reservada)** adaptada a **Hindi** — no traducción literal: adaptación de contexto (cultura, formato y tono de la plataforma, norma del idioma).
