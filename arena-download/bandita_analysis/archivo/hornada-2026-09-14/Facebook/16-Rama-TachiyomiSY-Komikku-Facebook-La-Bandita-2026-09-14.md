...
SY es el fork con más historia continua del ecosistema: existía antes del cierre del original, sobrevivió a enero de 2024 y sigue empujando código — lo hizo ayer mismo. Su ritmo no es el de releases mensuales: su última estable es de julio y su código se mueve desde entonces. El patrón del veterano: menos ruido de versiones, más mantenimiento silencioso.
...
Se abrieron HOY, fork por fork, las redes de SY (238 forks, tres páginas, dos órdenes) y de Komikku (200 forks). Es la red más rica del ecosistema — y la que mejor muestra la diferencia entre copiar y aportar:
...
```
Houri (PineappleTwilight)  ★10 · v1.22.0 HOY *(reverificado el 15-sep: v1.22.1 ya a la vista — la cadencia sigue)*
...
**La capa que el grafo esconde (cinco casas verificados HOY a petición de los grupos)**
...
- **tracker-extensions** (komikku-app, ★14): las extensiones de trackers de la casa Komikku — los trackers se sirven aparte del núcleo, como extensiones (verificado HOY). 
