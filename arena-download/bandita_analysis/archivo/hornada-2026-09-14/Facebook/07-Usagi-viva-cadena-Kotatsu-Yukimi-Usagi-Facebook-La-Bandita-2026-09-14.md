...
Corre que anda por los grupos: «Usagi fue archivada», «Usagi murió». Se verificó HOY, 14 de septiembre, en la casa misma del proyecto:
...
```
ACTO 1 — Kotatsu
KotatsuApp/Kotatsu · ★8.852
ARCHIVADO el 4 de noviembre de 2025 (confirmado HOY)
...
No quedó repo vivo que verificar HOY: por eso
...
★569 · **v2.1.2 publicada HOY mismo** · Apache-2.0 en su licencia declarada. Manga, novelas y vídeo en una sola app — la más movida del árbol esta semana (tres versiones en cuatro días). Tiene guía completa propia en esta familia.
...
**Gekkoushi/plugin-source** — https://github.com/Gekkoushi/plugin-source — ★90, GPL-3.0, push de HOY, versión 1.2.6. Aquí se contribuye y aquí se reportan las fuentes rotas.
...
La búsqueda de esta semana trajo una camada con el mismo traje — estrellas infladas e idénticas (115–120 mil), nacimiento de ayer, títulos de clasificado: «usagi-nightly», «usagi-sora-vn-sources», «komikku-scans», «translation-hub-stringsets». Ninguno es fork de Usagi ni fuente verificada: son imanes de clic con nombre prestado.
